...
from .utils import tanimoto
from rdkit import Chem
from rdkit.Chem import rdMolDescriptors

@tool
def MolSimilarity(
    smiles_pair:Annotated[str,"Input two molecule SMILES (separated by '.')"],
):
    '''
    MolSimilarity
...
@tool
def SMILES2Weight(smiles:Annotated[str,"Input SMILES"]):
    """
    SMILES2Weight
...
@tool
def FuncGroups(smiles:Annotated[str,"Input SMILES"]):
    """
    FunctionalGroups
