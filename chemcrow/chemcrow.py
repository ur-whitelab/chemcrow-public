...
# Replace also project-name to your project name.
HEADERS = {
    "userid": "muralidharan.a.2@pg.com",
    "project-name": "ChatMDS",
}

from dotenv import load_dotenv 
load_dotenv("/Users/muralidharan.a.2/.crewkey_azure", override=True)
env_credential = EnvironmentCredential()
token = env_credential.get_token(COGNITIVE_SERVICES).token
